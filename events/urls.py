...
urlpatterns = [
    ...
    path('export-events-word/', views.export_events_to_word, name='export-events-word'),
    path('event/<int:event_id>/download/', views.download_event_detail, name='download-event-detail'),
]
